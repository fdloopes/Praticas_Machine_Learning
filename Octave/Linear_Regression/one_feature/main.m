...
% Date: 03/03/2021
%
% This program aims to implement linear regression on a set of food truck efficiency data by city,
% to be able to predict where it will be more profitable to open a new food truck.
%
...
predict1 = [1, 35.0] *theta;
fprintf('For population = 35,000, we predict a profit of %f\n', predict1);

predict2 = [1, 70.0] * theta;
